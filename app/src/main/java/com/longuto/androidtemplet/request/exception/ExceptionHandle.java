    ...
    public static ResponeThrowable handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            switch (httpException.code()) {
                ...
                default:
                    ex.message = UiUtils.getString(R.string.http_error);
                    break;
            }
            return ex;
            ...
            ex.message = UiUtils.getString(R.string.net_error);
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new ResponeThrowable(e, ERROR.SSL_ERROR);
            ex.message = UiUtils.getString(R.string.ssl_error);
            return ex;
            ...
            ex.message = UiUtils.getString(R.string.unknow_error);
            return ex;
        }
    }
