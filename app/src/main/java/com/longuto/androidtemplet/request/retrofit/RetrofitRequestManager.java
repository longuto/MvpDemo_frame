...
import com.longuto.androidtemplet.request.retrofit.interceptor.BaseUrlInterceptor;
...
public class RetrofitRequestManager {
    ...
    private void initRetrofit() {
        mRetrofit = new Retrofit.Builder()
                .baseUrl(NetworkConstant.HOST)//配置服务器路径
//                .addConverterFactory(MyStringConverterFactory.create())//配置转化库，String
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .addConverterFactory(GsonConverterFactory.create())//配置转化库，FastJson
